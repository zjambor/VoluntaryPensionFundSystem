...
{
    public partial class BeazonFoglKivalaszt : BaseForm
    {
        ...
        public BeazonFoglKivalaszt(DataTable dt, Beazonositas szulo)
        {
            InitializeComponent();
        ...
        private void BeazonFoglKivalaszt_Resize(object sender, EventArgs e)
        {
