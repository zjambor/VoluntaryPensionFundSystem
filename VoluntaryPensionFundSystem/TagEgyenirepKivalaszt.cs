...
{
    public partial class TagEgyenirepKivalaszt : BaseForm
    {
        ...
        public TagEgyenirepKivalaszt(DataTable dt, Tag_keres szulo)
        {
            InitializeComponent();
        ...
        private void kivalaszt()
        {
            try
            {
                ...
                ba.Paj = int.Parse(dgvBankKiv.Rows[Sorindex].Cells[1].Value.ToString());
                ba.PnrId = int.Parse(dgvBankKiv.Rows[Sorindex].Cells[0].Value.ToString());
                ba.adoazon = dgvBankKiv.Rows[Sorindex].Cells[2].Value.ToString();
                ba.nev = dgvBankKiv.Rows[Sorindex].Cells[3].Value.ToString();
                ba.szulnev = dgvBankKiv.Rows[Sorindex].Cells[4].Value.ToString();
